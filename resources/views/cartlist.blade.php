                        ...
                        @foreach ($products as $data)
                            <tr>
                                <td class="col-sm-8 col-md-6">
                                    <div class="media">
                                        <a class="thumbnail pull-left" href="#"> <img class="media-object"
                                                src="{{ $data->gallery }}" style="width: 72px; height: 72px;"> </a>
                                        <div class="media-body">
                                            <h4 class="media-heading"><a href="#">{{ $data->name }}</a></h4>
                                            <h5 class="media-heading"> by <a href="#">{{ $data->category }}</a></h5>
                                ...
                                <td class="col-sm-1 col-md-1">
                                    <a href="/removcart/{{ $data->cart_id }}" type="button" class="btn btn-danger">
